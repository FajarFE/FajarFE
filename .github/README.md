...
<div style="display: grid; grid-template-columns: repeat(12, 1fr); gap: 10px; align-items: center;width:100%">
  <div style="grid-column: span 3; text-align: center; width:100%">
  ...
  <div style="grid-column: span 9;width:100%">
